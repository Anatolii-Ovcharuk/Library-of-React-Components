...
const Music = () => {
    ...
    const on_icon = <svg className='block__music__icon' version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="32" viewBox="0 0 34 32">
    ...
    const off_icon = <svg className='block__music__icon' version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
