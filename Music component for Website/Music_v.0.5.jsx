/* "Music component for Website", v. 0.5 - 19.09.2024 | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
import Music from './components/Music_v.0.5.jsx';
JSX string for render or return: <Music />
*/

import React, { useState, useEffect, useContext, useRef } from 'react';
const link_audio = "./audio/mp3/example.mp3"; // Укажите путь к аудиофайлу. Set src to audio here.
...
const Music = () => {
    ...
    const buffer = context.createBuffer(2, context.sampleRate * 1, context.sampleRate);
            ...
            /* First version with automatic playing */    
    const toggleAudio = () => {
        setPlay(prevValue => !prevValue);
        play ? console.log("Music ON.") : console.log("Music OFF.");
    }
    ...
    // console.log(context.createMediaElementSource(refsAudio))
    // console.log(context);
    // console.log(delay);
    // console.log(audio.duration);   
            ...
            /* Second version only with activating button */
    // const toggleAudio = () => {
    //     if (!audioContextRef.current) {
    //         volume.gain.value = 0.9;
