...
/* Add next string in application: import DiagramPie from './Diagram_pie_v.0.5'; */
    ...
    return (
        <section className="section" style={{margin: "10px"}}>
            ...
            <div className="section__diagram" style={{display: "flex", justifyContent: "center", alignItems: "center", gap: "15px", flexWrap: "wrap", flexDirection: "row"}}>
                ...
                <fieldset className={`field_pie_legend_${id}`} style={{position: "relative", width: width / 1.25, height: height, margin: "10px", display: "flex", alignItems: "center", justifyContent: "center"}}>
                    ...
                    <p id={`legend_pie_total_${id}`} style={{position: "absolute", bottom: "2px", left: "6px", fontSize: `${fontSize * 1.4}px`}}></p>
                </fieldset>
            </div>
