/* "PrivateRoute component", v. 0.2 - 11.11.2024 | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
const PrivateRoute: FC<PrivateRouteProps> | React.FC<PrivateRouteProps> = ({ access = false, redirectTo = '/' }) => {
