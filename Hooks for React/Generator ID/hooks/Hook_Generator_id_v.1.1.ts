...
// "use strict"; /* That's Strict mode;  ⛔ DONT USE OTHER CODE WITH THIS IS STRICT, IF YOUR ALL CODE NOT "USE STRICT" OR TYPE="MODULE"... */
    ...
    /* DEFAULT OPTIONS */
let USE_DATE: boolean = true; /* Include for Default in ID code date (true / false). */
let GENERATE_NUMBER: number = 6; /* Change for Default ammount generated numbers in ID */
