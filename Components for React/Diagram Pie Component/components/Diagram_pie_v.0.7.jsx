...
/* Add next string in application: import DiagramPie from './Diagram_pie_v.0.7'; */
...
const width = 120; // 120, 225, 250, 928
const height = width; // Math.min(width, 500), 250
const fontSize = 7; // Set numbers here in "px";
// CUSTOM COLORS (Array)
...
useEffect(() => {
    ...
    return (
        <section className="section" style={{margin: "10px"}}>
            <h3 className="section__name" style={{textAlign: "center", margin: "10px", fontSize: "14px"}} >Diagram {title}</h3>
            <div className="section__diagram" style={{display: "flex", justifyContent: "center", alignItems: "center", gap: "15px", flexWrap: "wrap", flexDirection: "row"}}>
                ...
                <fieldset className={`field_pie_legend_${id}`} style={{position: "relative", width: width / 1.25, height: height, margin: "10px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", overflowY: "scroll"}}>
                    ...
                    <p id={`legend_pie_total_${id}`} style={{position: "absolute", top: "4px", right: "6px", fontSize: `${fontSize * 1.4}px`}}></p>
                </fieldset>
            </div>
