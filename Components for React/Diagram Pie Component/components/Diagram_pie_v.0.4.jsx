/* "Diagram (pie) module", v. 0.4 - 01.11.2024 | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
const width = 250; // 225, 250, 928
const height = width; // Math.min(width, 500), 250
const fontSize = 9; // Set numbers here in "px";
// CUSTOM COLORS (Array)
    ...
    return (
        <section className="section" style={{margin: "10px"}}>
            ...
            <div className="section__diagram" style={{display: "flex", justifyContent: "center", alignItems: "center", gap: "15px", flexWrap: "wrap", flexDirection: "row"}}>
                ...
                <fieldset className={`field_pie_legend_${id}`} style={{position: "relative", width: width / 1.25, height: height, margin: "10px"}}>
                    <legend className={`field_pie_legend_text_${id}`}>Legend / Легенда</legend>
