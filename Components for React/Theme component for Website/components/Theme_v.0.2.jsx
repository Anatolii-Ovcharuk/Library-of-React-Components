/* "Theme component", v. 0.2 - 10.10.2024 | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
const Theme = () => {
  ...
  const [currentIndexStyle, setCurrentIndexStyle] = useState(() => {
    ...
    // Colors for theme (In key "name" use only value light/black)
  const classData = [
    // { name: 'light', backgroundColor: '#ffffff', color: '#000000', fill: '#000000' }, // Standart light theme
    // { name: 'black', backgroundColor: '#000000', color: '#ffffff', fill: '#ffffff' },  // Standart dark theme
    { name: 'light', backgroundColor: '#f9f9f9', color: '#252525', fill: '#252525', borderColor: '#252525' }, // Light theme
    { name: 'black', backgroundColor: '#252525', color: '#f9f9f9', fill: '#f9f9f9', borderColor: '#f9f9f9' },  // Dark theme
  ];
