/* "Saver Page PNG", v. 0.2 - 22.11.2024 React Edition | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
const SaveAsPng = () => {
  const handleSaveAsPng = async () => {
    try {
      const element = document.body; // Scan All document
