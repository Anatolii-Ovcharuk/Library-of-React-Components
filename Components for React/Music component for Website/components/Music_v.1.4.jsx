/* "Music component for Website", v. 1.4 - 20.11.2024 | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
const link_audio = "./audio/mp3/background.mp3"; // Укажите путь к аудиофайлу.
...
const Music = () => {
    ...
    const toggleAudio = () => {
        setPlay(!play);
        localStorage.setItem("musicPlayState", !play);
    };

    useEffect(() => {
        // Создание AudioContext и загрузка аудио.
    ...
    const playAudio = () => {
        if (audioContextRef.current && audioBufferRef.current) {
            ...
            source.loop = true;
            source.loopStart = 0.1; // Начало зацикливания (точка старта, в секундах)
            source.loopEnd = audioBufferRef.current.duration - 0.1; // Конец зацикливания
