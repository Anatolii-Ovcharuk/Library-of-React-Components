/* "Theme component", v. 0.4 - 20.10.2024 | MIT License | Made by Anatolii Ovcharuk - https://github.com/Anatolii-Ovcharuk */
...
import Theme from './components/Theme_v.0.4';
...
const Theme = () => {
  ...
  const [currentIndexStyle, setCurrentIndexStyle] = useState(() => {
    ...
    // Colors for theme (In key "name" use only value light/dark)
  const classData = [
    ...
    { name: 'light', backgroundColor: '#b39551', color: '#252525', fill: '#252525', borderColor: '#252525' }, // Светлая тема
    { name: 'dark', backgroundColor: '#252525', color: '#b39551', fill: '#b39551', borderColor: '#b39551' },  // Темная тема
  ];
  ...
  return (
    <section className='block__theme'>
            <button
                ...
                {icon === 'light' ? light_icon : dark_icon}
            </button>
    </section>
  );
};
